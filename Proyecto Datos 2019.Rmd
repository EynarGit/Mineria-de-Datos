...
```{r}
ggplot(MuertesXDep2019, aes(x = Depreg , y= n)) + geom_bar(stat="identity", fill="red", alpha=.6, width=.4) + labs(x="Departamento",y= "Frecuencia") 
```
#Grafico de causas Principales de Muerte 2019

```{r}
ggplot(subset(CausasMuerte2019,n>1000)) + geom_point(aes(x = Caudef , y= n))
```
#Grafico de Edad de Muerte 2019

```{r}

ggplot(EdadMuerte2019 + geom_line(aes(x=Edadif,y=n)))
...
ylab="Edad de Muerte", xlab ="Sexo", Main = "Defunciones 2019")
```
