...
```{r}
ggplot(MuertesXDep2017, aes(x = Depreg , y= n)) + geom_bar(stat="identity", fill="red", alpha=.6, width=.4) + labs(x="Departamento",y= "Frecuencia") 
```
#Grafico de causas Principales de Muerte 2017

```{r}
ggplot(subset(CausasMuerte2017,n>1000)) + geom_point(aes(x = Caudef , y= n))
```
#Grafico de Edad de Muerte 2017

```{r}

ggplot(EdadMuerte2017, aes(x= Edadif, y=n) + geom_bar())
...
ylab="Edad de Muerte", xlab ="Sexo", Main = "Defunciones 2017")
```
